...
@interface HBRNumberFormatter(Private)
...
@implementation HBRNumberFormatter
...
+ (id)defaultFormatter;
{
    static HBRNumberFormatter *_defaultFormatter;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultFormatter = [[HBRNumberFormatter alloc] init];
    });
